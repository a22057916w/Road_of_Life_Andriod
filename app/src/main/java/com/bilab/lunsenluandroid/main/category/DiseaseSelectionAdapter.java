...
public class DiseaseSelectionAdapter extends RecyclerView.Adapter<DiseaseSelectionAdapter.ViewHolder> {
    ...
    public DiseaseSelectionAdapter(Context context, ArrayList<DiseaseSelectionModel> diseaseSelectionModelArrayList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull DiseaseSelectionAdapter.ViewHolder holder, int position) {
